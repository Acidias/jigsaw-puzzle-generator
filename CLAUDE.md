...
- `Sources/Models/` - Data models:
  ...
  - `ModelState` - Central state for model management (models list, CRUD, training status/log/live metrics, training target, cloud config)
